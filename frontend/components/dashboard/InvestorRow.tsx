...
export function InvestorRow({ investor, brokerAlive }: InvestorRowProps) {
  ...
  return (
    <div className="flex items-center justify-between rounded-xl border border-[#FFFBB8]/[0.06] bg-[#FFFBB8]/[0.02] px-4 py-3 transition-all hover:border-[#FFFBB8]/[0.12]">
      <div className="flex items-center gap-3">
        <span
          className={`h-2 w-2 rounded-full ${alive ? "bg-[#FFFBB8]" : "bg-red-400"}`}
        />
        <div>
          ...
          {investor.state?.latestOwner &&
            investor.state.latestOwner !==
              ...
              <p className="font-mono text-[10px] text-[#F5F0E8]/20">
